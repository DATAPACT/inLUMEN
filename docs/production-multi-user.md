...
## Candidate deployment and concurrent-user testing

See [the VM load-test guide](vm-load-test.md) for deploying an exact candidate
commit or release tag, creating dedicated Keycloak test users, and running
